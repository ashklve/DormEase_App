...
import styles, { COLORS } from './announcements.styles';
...
const AnnouncementCard = ({ item }) => {
  ...
  return (
    <View style={styles.card}>
      ...
      {/* only render image block if image url exists and didn't error */}
...
export default function AnnouncementsScreen() {
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      // const res = await fetch('https://your-api.com/announcements');
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.bottomNav}>
        <NavItem iconName="home" label="Home" onPress={() => router.replace('/dashboard')} />
